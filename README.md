...
把散落在 **京东 / 淘宝 / Steam / 微信** 的订单，一键变成一张**可视化的装备库**，并自动算清每件物品的**日均持有成本**：

> **买贵但用久 = 真划算 · 买便宜但吃灰 = 真浪费**

## 🚀 1 秒上手

1. 📥 **下载安装**（或直接 [🖥️ 在线体验](https://bunnychen.top/BunnyChen-Item-Bookkeeping/)）
2. 🎁 打开 App，在空状态点击「**加载示例数据**」
3. 🎉 30 秒看到满屏装备卡片 + 数据分析图表，随时可一键清空

![1786678315977](docs/assets/首页一秒例子.png)

> 💡 内置「示例数据包」模拟一个数码爱好者的装备库——不用导入任何文件，先体验再导入。
...
<p align="center">  <img src="docs/assets/首页%20装备墙%20数码装备库.jpg" alt="装备墙 · 示例数据" width="90%" />
</p>
...
- 📥 **一键归集装备库** — 京东 / 淘宝 / Steam / 微信账单批量导入，自动去重、自动匹配分类与 emoji，散落的订单变成一张装备墙
