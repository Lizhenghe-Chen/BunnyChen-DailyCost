...
把散落在 **京东 / 淘宝 / Steam / 微信** 的订单，一键变成一张**可视化的资产账本**，并自动算清每件物品的**日均持有成本**：
...
<p align="center">  <img src="docs/assets/首页%20装备墙%20数码装备库.jpg" alt="资产墙 · 示例数据" width="90%" />
</p>
...
- 📥 **一键归集资产账本** — 京东 / 淘宝 / Steam / 微信账单批量导入，自动去重、自动匹配分类与 emoji，散落的订单变成一张资产墙
